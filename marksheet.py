...
def display():
    ...
    # 20*number of subject credits
    # give total credits for grade A
    if e4.get() == "A":
        # grid method is used for placing
        # the widgets at respective positions
        # in table like structure .
        tk.Label(master, text="80").grid(row=3, column=4)
        tot += 80

    # 18*number of subject credits give
    # total credits for grade B
    if e4.get() == "B":
        tk.Label(master, text="72").grid(row=3, column=4)
        tot += 72

    # 16*number of subject credits give
    # total credits for grade C
    if e4.get() == "C":
        tk.Label(master, text="64").grid(row=3, column=4)
        tot += 64

    # 14*number of subject credits
    # give total credits for grade D
    if e4.get() == "D":
        tk.Label(master, text="56").grid(row=3, column=4)
        tot += 56

    # 12*number of subject credits give
    # total credits for grade P
    if e4.get() == "P":
        tk.Label(master, text="48").grid(row=3, column=4)
        tot += 48
    ...
    if e5.get() == "A":
        tk.Label(master, text="80").grid(row=4, column=4)
        tot += 80
    if e5.get() == "B":
        tk.Label(master, text="72").grid(row=4, column=4)
        tot += 72
    if e5.get() == "C":
        tk.Label(master, text="64").grid(row=4, column=4)
        tot += 64
    if e5.get() == "D":
        tk.Label(master, text="56").grid(row=4, column=4)
        tot += 56
    if e5.get() == "P":
        tk.Label(master, text="48").grid(row=4, column=4)
        tot += 48
    if e5.get() == "F":
    ...
    if e6.get() == "A":
        tk.Label(master, text="60").grid(row=5, column=4)
        tot += 60
    if e6.get() == "B":
        tk.Label(master, text="54").grid(row=5, column=4)
        tot += 54
    if e6.get() == "C":
        tk.Label(master, text="48").grid(row=5, column=4)
        tot += 48
    if e6.get() == "D":
        tk.Label(master, text="42").grid(row=5, column=4)
        tot += 42
    if e6.get() == "P":
    ...
    if e7.get() == "A":
        tk.Label(master, text="80").grid(row=6, column=4)
        tot += 80
    if e7.get() == "B":
        tk.Label(master, text="72").grid(row=6, column=4)
        tot += 72
    if e7.get() == "C":
        tk.Label(master, text="64").grid(row=6, column=4)
        tot += 64
    if e7.get() == "D":
        tk.Label(master, text="56").grid(row=6, column=4)
        tot += 56
    if e7.get() == "P":
        tk.Label(master, text="48").grid(row=6, column=4)
        tot += 48
    if e7.get() == "F":
    ...
    # to display SGPA
    tk.Label(master, text=str(tot / 30)).grid(row=8, column=4)
...
tk.Label(master, text="Semester").grid(row=1, column=0)
...
tk.Label(master, text="STATS").grid(row=3, column=1)
tk.Label(master, text="ALGO").grid(row=4, column=1)
tk.Label(master, text="NETWORK").grid(row=5, column=1)
tk.Label(master, text="DBMS").grid(row=6, column=1)
...
tk.Label(master, text="Relative Marks").grid(row=2, column=4)
